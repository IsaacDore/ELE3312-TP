...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	...
	HAL_TIM_Base_Start(&htim2);
	HAL_DAC_Start_DMA(&hdac, DAC_CHANNEL_1, tab_value, TABLE_LENGTH, DAC_ALIGN_12B_R);
	#endif
	//END Experience 2
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		...
		char buf[80]; 
		sprintf(buf,"Min:%i\r\n",min_value); 
		ili9341_text_attr_t text_attr = {&ili9341_font_11x18,ILI9341_WHITE, ILI9341_BLACK,0,40};
		ili9341_draw_string(_screen, text_attr, buf);
		
		sprintf(buf,"Max:%i\r\n",max_value); 
		ili9341_text_attr_t text_attr2 = {&ili9341_font_11x18,ILI9341_WHITE, ILI9341_BLACK,0,80};
		ili9341_draw_string(_screen, text_attr2, buf);
		
		sprintf(buf,"dB:%i\r\n",db_value); 
		ili9341_text_attr_t text_attr3 = {&ili9341_font_11x18,ILI9341_WHITE, ILI9341_BLACK,0,120};
